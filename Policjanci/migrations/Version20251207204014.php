 ...
 */
final class Version20251207204014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movies (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL COLLATE "NOCASE", description CLOB DEFAULT NULL, release_year INTEGER NOT NULL, poster_path VARCHAR(255) DEFAULT NULL, is_adult BOOLEAN DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, is_series BOOLEAN DEFAULT NULL)');
